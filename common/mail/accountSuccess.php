                                                    ...
                                                    <table width="100%" cellspacing="0" cellpadding="0" border="0" align="center">
                                                        ...
                                                        <tr>
                                                            <td style="font-family: 'Montserrat', sans-serif !important; font-size:14px; padding-top:10px;  color:#484848; line-height:24px; padding-bottom:30px;" class="para1">
                                                               Congrasulations!! Your <a href="<?php $baseUrl;?>">Go Do Experience</a> account verified successfully.
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            <td style="font-family: 'Montserrat', sans-serif !important; font-size:14px; padding-top:10px;  color:#484848; line-height:24px; padding-bottom:30px;" class="para1">
                                                            If you did not request to verify this, please let us know & ignore this email. contact 
