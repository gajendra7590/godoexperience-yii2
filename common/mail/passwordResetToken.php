                                                ...
                                                <td>
                                                    <table width="100%" cellspacing="0" cellpadding="0" border="0" align="center">
                                                        ...
                                                        <tr>
                                                            ...
                                                            You recently requested for reset your passoword of <a href="<?php echo $baseUrl;?>">Go Do Experience</a> account,click on below button to reset your password.
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                                ...
                                                                <table style="background-color: #FF5A5F; border: 1px solid #FF5A5F; border-radius: 4px;" cellspacing="0" cellpadding="0" align="center">
                                                                    ...
                                                                    <tr>
                                                                        <td style="padding-left: 15px; padding-right: 15px; text-align: center; cursor: pointer" valign="middle" height="45" width="164">
                                                                            <a href="<?php echo Html::encode($resetLink);?>" target="_blank"  style="display: block; font-family: 'Montserrat', sans-serif !important; border-radius: 4px; font-size: 14px; line-height: 14px; color: #fff; text-decoration: none; font-weight: 500">
                                                        ...
                                                        <tr>
                                                            <td style="font-family: 'Montserrat', sans-serif !important; font-size:14px; padding-top:10px;  color:#484848; line-height:24px; padding-bottom:30px;" class="para1">
                                                            If you did not request a password reset, please let us know & ignore this email. contact 
